...
class DerivativeVandermondeSpaceWithInert():
    ...
    def __init__(self, R, mu, inert=1, antisymmetries=None):
        self._antisymmetries = antisymmetries
        self._R = R
        ...
        self._antisymmetries = antisymmetries
        if antisymmetries: 
            self._polRing = DiagonalAntisymmetricPolynomialRing(R, self._n, 1, inert, antisymmetries)
        else:
    ...
    @cached_method
    def basis_by_shape(self, verbose=True):
        """
