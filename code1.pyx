...
def antisymmetric_normal(p, int n, int r, list positions):
    ...
    - `r`, `n` -- nonnegative integers
    - `positions` -- a subset `I` of `\{0,..., r-2\}`

    Let `W` be the parabolic subgroup of the symmetric group
    of the columns generated by `\{s_i, i in I\}`. Let
    `b_I` be the antisymmetrizer w.r.t. `W`.
