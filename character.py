...
def character_with_inert(mu, inert=1, verbose=False, use_antisymmetry=False, row_symmetry=None, parallel=False): 
    """
    ...
    if parallel:
        charac = 0
        for (((_,nu,_,_,_,_,),_),res) in character_by_isotypic_paral([(mu, nu, inert, use_antisymmetry, row_symmetry, verbose) 
...
@parallel
def character_by_isotypic_paral(mu, nu, inert=1, use_antisymmetry=False, row_symmetry=None, verbose=False):
    """
    """
    return character_by_isotypic_plain(mu, nu, inert, use_antisymmetry, row_symmetry, verbose)
...
def character_isotypic_plain_hash(mu, nu):
