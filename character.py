...
def character_with_inert(mu, inert=1, verbose=False, use_antisymmetry=False, row_symmetry=None, parallel=True): 
    ...
    if parallel:
        ...
        for nu in Partitions(n):
            res = character_by_isotypic(mu, nu, inert=inert, use_antisymmetry=use_antisymmetry, row_symmetry=row_symmetry, verbose=verbose)
            if res:
...
@parallel()
def character_by_isotypic(mu, nu, inert=1, use_antisymmetry=False, row_symmetry=None, verbose=False):
    """
