...
def character_by_isotypic_plain(mu, nu, inert=1, use_antisymmetry=False, row_symmetry=None, quotient=False, verbose=False):
    """
...
def character_quotient(P, basis, degree, row_symmetry=None):
    """
    ...
    for k in range(0, r):
        operators[grading_set((-1 if j==k else 0 for j in range(0,r)))] += [functools.partial(P.steenrod_op, i=k)]
