...
class DiagonalAntisymmetricPolynomialRing(UniqueRepresentation, Parent):
    """
    ...
    def polarization_antisym(self, p, i1, i2, d, use_symmetry=False, antisymmetries=None):
        """
        
        """
        result = self.polarization(p, i1, i2, d, use_symmetry=use_symmetry)
        if antisymmetries result:
            result = antisymmetric_normal(result, self._n, self._r, antisymmetries)
        return result

    def multi_polarization_antisym(self, p, D, i2, antisymmetries=None):
        """
    ...
    def polarization_operators_by_multidegree_antisym(self, side=None, use_symmetry=False, ,antisymmetries=None, min_degree=0):
        """
    ...
    def polarization_operators_by_degree_antisym(self,side=None, use_symmetry=False, antisymmetries=None, min_degree=0):
    ...
    @cached_method
    def isotypic_basis_antisym(self,mu,verbose=True):
        """
            Let $W$ be the smallest submodule generated by a Vandermonde $\Delta$ depending on 
            a partition`mu` and closed under partial derivatives.
            Then $W$ can be decomposed into isotypic components for the action of $S_n$. This function 
